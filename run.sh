...
do
    ...
    TT_METAL_DEVICE_PROFILER=1 ./tt-metal_matmul_64cores/build/stencil $ITERATIONS 1024 1024 >> logs/matmul_${ITERATIONS}.out
...
do
    ...
    TT_METAL_DEVICE_PROFILER=1 ./tt-metal_axpy_64cores/build/stencil $ITERATIONS 1024 1024 >> logs/axpy_${ITERATIONS}.out
