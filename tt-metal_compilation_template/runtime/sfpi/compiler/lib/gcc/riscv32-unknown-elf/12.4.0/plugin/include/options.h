...
#endif
#ifdef GENERATOR_FILE
extern int riscv_tt_flags;
#else
  int x_riscv_tt_flags;
#define riscv_tt_flags global_options.x_riscv_tt_flags
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mcpu_ = 1780,                          /* -mcpu= */
  OPT_mdiv = 1781,                           /* -mdiv */
  OPT_mexplicit_relocs = 1782,               /* -mexplicit-relocs */
  OPT_mfdiv = 1783,                          /* -mfdiv */
  OPT_misa_spec_ = 1784,                     /* -misa-spec= */
  OPT_mlittle_endian = 1785,                 /* -mlittle-endian */
  OPT_mplt = 1786,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1787,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1788,                         /* -mrelax */
  OPT_mriscv_attribute = 1789,               /* -mriscv-attribute */
  OPT_msave_restore = 1790,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1791,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1792,             /* -msmall-data-limit= */
  OPT_mstack_protector_guard_offset_ = 1793, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1794,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1795,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1796,                  /* -mstrict-align */
  OPT_mtune_ = 1797,                         /* -mtune= */
  OPT_mwormhole_a0 = 1798,                   /* -mwormhole_a0 */
  OPT_n = 1799,                              /* -n */
